# workflow_with_no_websocket_error_modified_and_cleaned_fullest
ComfyUI workflow Dockerized via [comfyui-wizard](https://comfy.getrunpod.io).
Submission: https://comfy.getrunpod.io/dashboard/submissions/kd7fgq9cf4bt0eq1rmy4s4vr8189teg5
## Build it yourself
```bash
